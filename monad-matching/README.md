...
**English (one line):** Wallet-native matching on Monad Testnet with ZK badges for private trust (balance & age), on-chain match economics and anti-ghosting, and optional Supabase chat.
